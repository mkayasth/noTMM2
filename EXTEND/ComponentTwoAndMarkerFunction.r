ComponentTwoAndMarkerFunction <- function(DataRanks2,TERCrank,Datasize){
...
TERCrank = match("TERC",rownames(DataRanks3))
Correl3 = as.numeric(cor.test(as.numeric(CumSum1$RawRankSum),as.numeric(DataRanks3[TERCrank,]),method='spearman')$estimate)   ### correlation of TERCrank and the Cumsum
PenalizingFactor = 1-Correl3    
DataRanks3[TERCrank,] = DataRanks3[TERCrank,]/PenalizingFactor
...
} ### ComponentTwoAndMarkerFunction ENDS HERE
